...
myst:
  html_meta:
    "description": "A new Plone project using Aurora with a Python CMFPlone backend."
    "property=og:description": "A new Plone project using Aurora with a Python CMFPlone backend."
    "property=og:title": "Project Title"
    "keywords": "Project Title, documentation, A new Plone project using Aurora with a Python CMFPlone backend."
---
